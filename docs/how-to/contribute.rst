.. meta::
   :description: Familiarize yourself with contributing to the mattermost-k8s charm documentation.
...
.. note::
   ...
   See the `contributing guide <https://github.com/canonical/mattermost-k8s-operator/blob/main/CONTRIBUTING.md>`_
...
Our documentation is also available alongside the `source code on GitHub <https://github.com/canonical/mattermost-k8s-operator>`_.
You may open a pull request with your documentation changes, or you can
`file a bug <https://github.com/canonical/mattermost-k8s-operator/issues>`_
