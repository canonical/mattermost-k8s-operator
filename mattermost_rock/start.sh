...
# Image proxy
export MM_IMAGEPROXYSETTINGS_ENABLE="$(to_mm_bool "$APP_IMAGE_PROXY_ENABLED")"
...
export MM_SERVICESETTINGS_CLOSEUNUSEDDIRECTMESSAGES="$(to_mm_bool "$APP_CLOSE_UNUSED_DIRECT_MESSAGES")"
export MM_SERVICESETTINGS_ENABLECUSTOMEMOJI="$(to_mm_bool "$APP_ENABLE_CUSTOM_EMOJI")"
export MM_SERVICESETTINGS_ENABLELINKPREVIEWS="$(to_mm_bool "$APP_ENABLE_LINK_PREVIEWS")"
export MM_SERVICESETTINGS_ENABLEUSERACCESSTOKENS="$(to_mm_bool "$APP_ENABLE_USER_ACCESS_TOKENS")"
